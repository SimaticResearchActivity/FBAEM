...
void SequencerAlgoLayer::handleMessageAsHost(std::unique_ptr<CommPeer> peer, const std::string &msgString)
{
...
void SequencerAlgoLayer::handleMessageAsNonHostPeer(std::unique_ptr<CommPeer> peer, const std::string &msgString)
{
